...
import '../../../domain/model/request/home_project_model.dart' show HomeProjectModel;
  ...
  FVoid _updateProject(
    ...
    result.fold(
      ...
      (updatedProject) {
        ...
        final updatedProjects = state.data?.map((p) => 
  ...
  FVoid _deleteProject(
    ...
    result.fold(
      ...
      (_) {
        ...
        final updatedProjects = state.data?.where(
